...
canvas.create_polygon(0,550,0,600,50,600,fill="white")
canvas.create_polygon(100,550,50,600,150,600,fill="white")
canvas.create_polygon(200,550,150,600,250,600,fill="white")
canvas.create_polygon(300,550,250,600,350,600,fill="white")
canvas.create_polygon(400,550,350,600,450,600,fill="white")
canvas.create_polygon(500,550,450,600,500,600,fill="white")